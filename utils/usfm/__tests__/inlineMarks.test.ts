...
describe("buildRunNodes — the leading-space convention, whitespace folding, and end-to-end merge over real fixture shapes", () => {
  it("should attach the joining space between two Strong's-tagged words to the leading edge of the node after the gap, never trailing the node before it (KJV1769 convention)", () => {
