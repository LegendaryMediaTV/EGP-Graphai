...
```
 bible-books/           # Canonical book registry and schema
 bible-versions/        # Version folders (ASV1901, KJV1769, etc.)
    {version}/
        _version.json  # Version metadata (name, license, book order)
        NN-BBB.json    # Verse files (e.g., 01-GEN.json … 66-REV.json)
