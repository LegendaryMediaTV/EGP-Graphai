...
Project overview, install/run commands, and JSON examples live in the [project README](../../../README.md). This folder explains the _why_ behind the data shapes and the moving parts that turn JSON files into rendered Scripture.
