 ...
 *
 * `romanize` mirrors the reader's transliteration setting, so a tooltip reads
 * in the same script as the text it describes rather than reverting to Greek
 * or Hebrew under a romanized chapter.
 *
